  ...
  useEffect(() => {
    ...
    careersApi.getById(id)
      .then((res) => {
        ...
        if (!job) { router.push('/admin/careers'); return }
        setForm({
          title: job.title || '',
      ...
      .catch(() => router.push('/admin/careers'))
  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-4 mb-6">
        <Link href="/admin/careers" className="flex items-center gap-1.5 font-ui text-xs tracking-wider uppercase" style={{ color: 'rgba(60,48,40,0.5)' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex items-center gap-4 mt-5">
          ...
          <Link href="/admin/careers" className="btn-outline-gold" style={{ fontSize: '0.75rem', padding: '0.75rem 1.5rem', color: 'var(--luxury-dark)', borderColor: 'rgba(212,175,55,0.45)' }}>
            Cancel
          </Link>
        </div>
      </form>
