  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/admin/events/new" className="btn-gold flex items-center gap-2" style={{ fontSize: '0.75rem', padding: '0.625rem 1.25rem' }}>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="font-body text-sm" style={{ color: 'rgba(60,48,40,0.45)' }}>
              No events yet. <Link href="/admin/events/new" style={{ color: 'var(--gold-dark)' }}>Add one</Link>.
            </p>
          </div>
        ) : (
