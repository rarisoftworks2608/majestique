  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/admin/news/new" className="btn-gold flex items-center gap-2" style={{ fontSize: '0.75rem', padding: '0.625rem 1.25rem' }}>
      ...
      <div style={{ background: 'white', border: '1px solid rgba(201,168,76,0.15)', overflow: 'hidden' }}>
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="font-body text-sm" style={{ color: 'rgba(60,48,40,0.45)' }}>No articles yet. <Link href="/admin/news/new" style={{ color: 'var(--gold-dark)' }}>Write one</Link>.</p>
          </div>
        ) : (
