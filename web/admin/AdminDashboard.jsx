...
function StatCard({ icon: Icon, label, value, sub, color, to }) {
  ...
  return to ? <Link href={to} style={{ textDecoration: 'none', display: 'block' }}>{inner}</Link> : inner
}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/admin/enquiries" className="flex items-center gap-1 font-ui text-xs tracking-widest uppercase" style={{ color: 'var(--gold-dark)' }}>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/admin/projects" className="flex items-center gap-1 font-ui text-xs tracking-widest uppercase" style={{ color: 'var(--gold-dark)' }}>
              All <ArrowRight size={11} />
            </Link>
          </div>
          <div style={{ background: 'white', border: '1px solid rgba(201,168,76,0.15)', overflow: 'hidden' }}>
