...
function ColHeading({ children }) {
  /* h2, not h4: the footer sits directly under the page's h1, so an h4 here
     skipped two levels and broke the document outline. Styling is unchanged
     — the heading level is what screen readers announce. */
  return (
    <h2 className="font-ui text-sm tracking-[0.14em] uppercase font-bold mb-5 leading-snug" style={{ color: 'var(--gold)' }}>
      {children}
    ...
    <footer style={{ background: 'var(--luxury-dark)' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(212,175,55,0.12)' }}>
        <div className="container-luxury py-3">
          <p className="font-body text-[10px] text-center leading-relaxed" style={{ color: 'rgba(243,239,232,0.62)' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(212,175,55,0.12)', background: 'rgba(26,26,26,0.3)' }}>
        <div className="container-luxury py-6 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 w-full">
            <p className="font-body text-xs" style={{ color: 'rgba(243,239,232,0.62)' }}>
            ...
            <div className="flex items-center gap-6">
              {[
                ...
                <Link
                  ...
                  style={{ color: 'rgba(243,239,232,0.62)' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--gold)')}
                  onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(243,239,232,0.62)')}
                >
                  {label}
                </Link>
              ))}
