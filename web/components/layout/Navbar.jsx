...
import logoImg from '../../assets/logos/Majestique_logo.webp'
    ...
    >
      ...
      >
        ...
        <div className="relative overflow-hidden" style={{ height: '110px' }}>
          <Image src={mini.image} alt={mini.title} className="object-cover" style={{ transform: 'scale(1.05)' }} fill sizes="(max-width: 1024px) 50vw, 320px" />
        </div>
        {/* Content */}
        <div className="p-4">
            ...
            return (
              ...
              >
                ...
                <div className="relative shrink-0 overflow-hidden" style={{ width: '96px', height: '72px' }}>
                  <Image src={child.image} alt={child.label} className="object-cover" style={{ transform: isActive ? 'scale(1.08)' : 'scale(1)', transition: 'transform 0.5s ease' }} fill sizes="(max-width: 1024px) 50vw, 320px" />
...
export default function Navbar() {
  ...
  if (prevPathname !== pathname) {
    ...
    /* Guarded: this block runs during render, which also happens on the
       server during prerendering where `window` does not exist. */
    if (typeof window !== 'undefined') setScrolled(window.scrollY > 60)
  }
          ...
          <div className="container-luxury flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center group shrink-0">
              <img
                ...
                style={{ mixBlendMode: 'screen' }} loading="lazy" decoding="async" />
            </Link>
                  ...
                  >
                    {link.children ? (
                      ...
                      <Link
                        ...
                        style={{ color: pathname === link.path ? P.gold : navLinkColor }}
                        onMouseEnter={(e) => { e.currentTarget.style.color = P.gold }}
                        onMouseLeave={(e) => {
            ...
            >
              ...
              >
                <Link href="/" className="flex items-center" onClick={() => setMobileOpen(false)}>
                  <img src={imgSrc(logoImg)} alt={SITE_NAME} className="h-9 w-auto"
                    style={{ mixBlendMode: 'screen' }} loading="lazy" decoding="async" />
                </Link>
                <button
                  onClick={() => setMobileOpen(false)}
                  ...
                  <motion.div key={link.path} variants={fadeUp}>
                    {link.children ? (
                                ...
                                {link.children.map((child) => {
                                  ...
                                  return (
                                    <Link
                                      ...
                                      style={{
                                        color: pathname === child.path ? P.ivory : P.smoke,
                                        background: pathname === child.path ? P.goldA(0.15) : 'transparent',
                                      }}
                                      onClick={() => setMobileOpen(false)}
                                    >
                      ...
                      <Link
                        ...
                        style={{ color: pathname === link.path ? P.ivory : P.ivoryA(0.72) }}
                        onClick={() => setMobileOpen(false)}
                      >
                        {link.label}
                      </Link>
