            ...
            <SwiperSlide key={idx}>
              {({ isActive }) => (
                <div
                  ...
                  onClick={() => router.push(`/media/awards/${award.slug}`)}
                  onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); router.push(`/media/awards/${award.slug}`) } }}
                ...
                >
                  <img src={imgSrc(award.image)} alt={award.award}
