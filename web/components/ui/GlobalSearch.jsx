...
const SEARCH_SECTIONS = [
  ...
  { label: 'CSR', path: '/media/csr', category: 'Media' },
  ...
  { label: 'People & Culture', path: '/about/people-culture', category: 'About' },
  { label: 'Employee Engagement Photos', path: '/about/employee-engagement', category: 'About' },
