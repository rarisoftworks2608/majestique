  ...
  return (
    ...
    >
      {/* Background image — slow Ken Burns drift.
          Previously a CSS background-image, which the image optimizer cannot
          see. As a <Image priority fill> it is served as AVIF/WebP at the
          right size and preloaded — this is the LCP element on ~25 pages. */}
      {bgImage && (
        <motion.div
