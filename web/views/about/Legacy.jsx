    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image src={legacyHero} alt="Majestique Landmarks" className="object-cover object-[center_30%]" fill sizes="100vw" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative overflow-hidden" style={{ aspectRatio: '4/5' }}>
                <Image src={legacyImg} alt="Majestique Landmarks Legacy" className="object-cover" fill sizes="100vw" />
