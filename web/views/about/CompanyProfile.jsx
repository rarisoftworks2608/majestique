          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fL()}>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link href="/about/vision-mission" className="btn-outline-dark transition-transform duration-300 hover:scale-105">Our Vision</Link>
              </div>
            </motion.div>

            <motion.div {...fR(0.12)} className="relative">
              <div className="relative overflow-hidden" style={{ aspectRatio: '4/3' }}>
                <Image src="https://majestiqueproperties.com/wp-content/uploads/2025/03/Evolvus-By-Majestique-Landmarks-Elevation-Image-01-scaled.webp" alt="Majestique Evolvus" className="object-cover" fill sizes="100vw" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fL()} className="relative">
              <div className="relative overflow-hidden" style={{ aspectRatio: '3/4' }}>
                <Image src="https://majestiqueproperties.com/wp-content/uploads/2025/03/Rhythm-County-Elevation-01-scaled.webp" alt="Majestique Rhythm County" className="object-cover" fill sizes="100vw" />
        ...
        <div className="container-luxury">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fR(0.12)} className="order-1 lg:order-2 relative">
              <div className="relative overflow-hidden" style={{ aspectRatio: '4/3' }}>
                <Image src="https://majestiqueproperties.com/wp-content/uploads/2025/03/Aravali-01-scaled.webp" alt="Majestique Aravali" className="object-cover" fill sizes="100vw" />
        ...
        <div className="container-luxury text-center relative">
          <motion.div {...fU()}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link href="/projects/ongoing" className="btn-gold transition-transform duration-300 hover:scale-105">View Ongoing Projects</Link>
