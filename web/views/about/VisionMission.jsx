          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fL()}>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link href="/about/milestones" className="btn-gold transition-transform duration-300 hover:scale-105">Our Journey</Link>
                <Link href="/about/leadership" className="btn-outline-dark transition-transform duration-300 hover:scale-105">Meet Our Leaders</Link>
              </div>
            </motion.div>

            <motion.div {...fR(0.12)} className="relative">
              <div className="relative overflow-hidden" style={{ aspectRatio: '4/3' }}>
                <Image src={visionContentImg} alt="Majestique Vision: Premium Urban Development" className="object-cover" fill sizes="100vw" />
              </div>
            </motion.div>
          </div>
        </div>
