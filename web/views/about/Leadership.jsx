            ...
            {LEADERS.map((leader, i) => (
              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ aspectRatio: '4/5' }}>
                  <Image src={leader.image} alt={leader.name} className="object-cover object-top transition-transform duration-700 ease-out group-hover:scale-[1.08]" fill sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
        ...
        <div className="container-luxury relative text-center max-w-3xl mx-auto">
          <motion.div {...fU()}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <Link href="/about/milestones" className="btn-outline-dark transition-transform duration-300 hover:scale-105">Our Journey</Link>
            </div>
          </motion.div>
        </div>
      </section>
