            ...
            {[...AWARDS_WITH_IMAGES, ...AWARDS_WITH_IMAGES].map((award, i) => (
              ...
              >
                <div className="relative overflow-hidden" style={{ aspectRatio: '4/3', background: '#f0ede4', flexShrink: 0 }}>
                  <Image src={award.image} alt={award.award} className="object-cover transition-transform duration-500 group-hover:scale-105" fill sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
                </div>
