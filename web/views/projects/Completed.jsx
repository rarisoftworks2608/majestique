      ...
      >
        ...
        <div className="container-luxury flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            <Link href="/projects/ongoing" className="btn-outline-gold transition-transform duration-300 hover:scale-105" style={{ fontSize: '0.75rem' }}>
              View Ongoing
            </Link>
            <Link href="/contact" className="btn-gold transition-transform duration-300 hover:scale-105">Enquire Now</Link>
          </div>
        </div>
      </section>
    </>
