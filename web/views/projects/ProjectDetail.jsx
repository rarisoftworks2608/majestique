    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--cream)' }}>
        <div className="text-center px-6">
          ...
          <Link href="/projects/ongoing" className="btn-gold transition-transform duration-300 hover:scale-105">Browse All Projects</Link>
        </div>
      </div>
    )
  }
            ...
            >
              {allImages.slice(1, 4).map((img, i) => (
                <button key={i} onClick={() => setGalleryIndex(i + 1)}
                  ...
                  <Image src={img?.url || img} alt="" className="object-cover transition-transform duration-500 group-hover:scale-110" fill sizes="100vw" />
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-4">
                          {allImages.slice(0, 3).map((img, i) => (
                            <button key={i} onClick={() => setGalleryIndex(i)}
                              ...
                              <Image src={img?.url || img} alt={img?.caption || `Photo ${i + 1}`} className="object-cover transition-transform duration-600 group-hover:scale-110" fill sizes="100vw" />
                    ...
                    {allImages.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          ...
                          onClick={() => setGalleryIndex(0)}
                        >
                          <Image src={allImages[0]?.url || allImages[0]} alt="Main" className="object-cover transition-transform duration-700 group-hover:scale-105" fill sizes="100vw" />
                            ...
                            {allImages.slice(1, 5).map((img, i) => {
                              ...
                              return (
                                <button key={i}
                                  ...
                                  <Image src={img?.url || img} alt={img?.caption || `Photo ${i + 2}`} className="object-cover transition-transform duration-500 group-hover:scale-110" fill sizes="100vw" />
                                  {isLast ? (
                                    <div className="absolute inset-0 flex items-center justify-center"
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 pt-1">
                            {allImages.slice(5).map((img, i) => (
                              <button key={i}
                                ...
                                <Image src={img?.url || img} alt={img?.caption || `Photo ${i + 6}`} className="object-cover transition-transform duration-500 group-hover:scale-110" fill sizes="100vw" />
                                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                          ...
                          <AnimatePresence mode="wait">
                            <motion.div key={activePlan}
                              ...
                              <button
                                ...
                                <img
                                  src={imgSrc(project.floorPlans[activePlan].imageUrl)}
                                  alt={project.floorPlans[activePlan].label}
                                  className="w-full object-contain max-h-[400px] p-4 transition-transform duration-500 group-hover:scale-105" loading="lazy" decoding="async" />
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                          ...
                          <div className={amenityGroups.length > 0 ? 'mt-10' : ''}>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                              {amenityImages.map((img, i) => (
                                ...
                                >
                                  <Image src={img.url} alt={img.altText || img.caption || 'Amenity'} className="object-cover transition-transform duration-500 group-hover:scale-110" fill sizes="100vw" />
                                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center"
                                    style={{ background: 'rgba(26,26,26,0.42)' }}>
                                    <Eye size={20} style={{ color: 'var(--gold)' }} />
                                  </div>
        ...
        <div className="container-luxury relative text-center max-w-2xl mx-auto">
          <motion.div {...fU()}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <Link href={backPath} className="btn-outline-gold transition-transform duration-300 hover:scale-105">
