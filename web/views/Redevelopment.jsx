    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ background: 'var(--luxury-dark)' }}>
        ...
        <div className="absolute inset-0">
          <Image src={towersImg} alt="" aria-hidden className="object-cover object-center opacity-[0.28]" fill sizes="100vw" />
        ...
        <div className="container-luxury relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <motion.div {...fL()}>
              ...
              <Link href="/contact" className="btn-gold transition-transform duration-300 hover:scale-105">Start the Conversation</Link>
            </motion.div>
            ...
            {PROJECTS.map((proj, i) => (
              ...
              >
                ...
                <div className={`relative overflow-hidden ${i % 2 === 1 ? 'lg:order-2' : ''}`} style={{ aspectRatio: '16/10', minHeight: '280px' }}>
                  <Image src={proj.image} alt={proj.name} className="object-cover transition-transform duration-700 group-hover:scale-105" fill sizes="100vw" />
      ...
      <section className="relative overflow-hidden" style={{ background: 'var(--luxury-dark)' }}>
        ...
        <div className="absolute inset-0">
          <Image src={nfsElevImg} alt="" className="object-cover opacity-15" fill sizes="100vw" />
        ...
        <div className="container-luxury relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fL()}>
              ...
              <Link href="/contact" className="btn-gold transition-transform duration-300 hover:scale-105">Speak With Our Experts</Link>
            </motion.div>
            <motion.div {...fR(0.1)}>
      ...
      <section className="py-16 relative overflow-hidden" style={{ background: 'var(--luxury-dark2)' }}>
        {/* Background image */}
        <div className="absolute inset-0">
          <Image src={twilightImg} alt="" aria-hidden className="object-cover object-center opacity-[0.22]" fill sizes="100vw" />
      ...
      <section className="section-pad relative overflow-hidden" style={{ background: 'white' }}>
        ...
        <div className="absolute inset-0">
          <Image src={contactBgImg} alt="" aria-hidden className="object-cover object-center opacity-[0.04]" fill sizes="100vw" />
