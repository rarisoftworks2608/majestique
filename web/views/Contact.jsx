        ...
        <Field error={errors.privacy}>
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span className="font-body text-sm leading-snug" style={{ color: 'rgba(26,26,26,0.65)' }}>
              ...
              <Link href="/privacy-policy" className="underline" style={{ color: 'var(--gold)' }}>
                privacy policy.
              </Link>{' '}
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden mb-8" style={{ height: '240px' }}>
        <Image src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1000&q=80" alt="Careers at Majestique" className="object-cover" style={{ objectPosition: 'center 30%' }} fill sizes="100vw" />
...
function ChannelPartnerPanel() {
  return (
    ...
    >
      {/* Image banner */}
      <div className="relative overflow-hidden mb-8" style={{ height: '240px' }}>
        <Image src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1000&q=80" alt="Channel Partners" className="object-cover" style={{ objectPosition: 'center 40%' }} fill sizes="100vw" />
...
export default function Contact() {
  ...
  /* ?tab= is read after mount rather than via useSearchParams. Calling
     useSearchParams here would opt the whole page out of prerendering,
     leaving the initial HTML (including the <h1>) empty for crawlers.
     The deep link still works — it just applies one paint later. */
  useEffect(() => {
    const requested = new URLSearchParams(window.location.search).get('tab')
    if (requested && TAB_IDS.includes(requested)) setActiveTab(requested)
  }, [])
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ height: '180px' }}>
                  <Image src={contactOfficeImg} alt="Majestique Office" className="object-cover" style={{ opacity: 0.55 }} fill sizes="100vw" />
                  ...
                  <div className="space-y-5 mb-7">
                    {CONTACT_INFO.map((info, i) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="font-ui text-[10px] tracking-[0.18em] uppercase mb-0.5" style={{ color: 'rgba(243,239,232,0.66)' }}>
                            {info.label}
                          </p>
                          {info.href ? (
                            <a
