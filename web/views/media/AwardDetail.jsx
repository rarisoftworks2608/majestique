    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--cream)' }}>
        <div className="text-center">
          ...
          <Link href="/media/awards" className="btn-outline-gold">← Back to Awards</Link>
        </div>
      </div>
    )
  }
        ...
        <div className="container-luxury">
          <div className="max-w-3xl mx-auto">
            ...
            <motion.button
              ...
              onClick={() => router.push('/media/awards')}
                ...
                >
                  ...
                  >
                    <div className="relative overflow-hidden" style={{ aspectRatio: '4/3', background: '#FAF6EF' }}>
                      {r.image ? (
                        <Image src={r.image} alt={r.award} className="object-cover transition-transform duration-600 group-hover:scale-[1.05]" fill sizes="100vw" />
                      ) : (
