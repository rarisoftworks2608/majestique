    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--cream)' }}>
        <div className="text-center">
          ...
          <Link href="/media/press-coverage" className="btn-outline-gold">← Back to Press Coverage</Link>
        </div>
      </div>
    )
  }
        ...
        <div className="container-luxury">
          <div className="max-w-3xl mx-auto">
            ...
            <motion.button
              ...
              onClick={() => router.push('/media/press-coverage')}
              ...
              {item.image ? (
                ...
                >
                  <img
                    ...
                    style={{ maxHeight: '560px' }} loading="lazy" decoding="async" />
                </div>
              ) : (
                <div
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {related.map((r, i) => {
                ...
                return (
                  ...
                  >
                    <Link
                      href={`/media/press-coverage/${r.slug}`}
                    ...
                    >
                      <div className="relative overflow-hidden" style={{ aspectRatio: '4/3', background: '#FAF6EF' }}>
                        {r.image ? (
                          <Image src={r.image} alt={r.headline} className="object-contain p-3 transition-transform duration-600 group-hover:scale-[1.05]" fill sizes="100vw" />
                        ) : (
