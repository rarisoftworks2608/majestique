        ...
        <div className={`grid grid-cols-1 sm:grid-cols-2 ${videos.length >= 4 ? 'lg:grid-cols-4' : 'lg:grid-cols-3'} gap-6 ${videos.length === 1 ? 'max-w-2xl mx-auto' : ''}`}>
          {videos.map((vid, i) => (
            <motion.div
              ...
              style={{ border: '1px solid rgba(212,175,55,0.14)', boxShadow: '0 2px 16px rgba(26,26,26,0.05)' }}
            >
      ...
      <section className="py-14 relative" style={{ background: 'white' }}>
        ...
        <div className="container-luxury">
          <motion.div {...fU()} className="text-center max-w-3xl mx-auto">
            <div className="font-display select-none mb-3" style={{ fontSize: '6rem', color: 'rgba(212,175,55,0.15)', lineHeight: 0.7 }}>"</div>
            ...
            <p className="font-ui text-xs tracking-widest uppercase" style={{ color: 'rgba(212,175,55,0.6)' }}>Majestique Landmarks Philosophy</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-luxury text-center relative">
          <motion.div {...fU()}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <Link href="/contact" className="btn-outline-dark transition-transform duration-300 hover:scale-105">Schedule a Visit</Link>
            </div>
          </motion.div>
        </div>
      </section>
