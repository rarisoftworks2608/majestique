          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-center gap-3">
                <Link href="/projects/ongoing" className="btn-gold transition-transform duration-300 hover:scale-105" style={{ fontSize: '0.75rem' }}>View Projects</Link>
                <Link href="/contact" className="btn-outline-dark transition-transform duration-300 hover:scale-105" style={{ fontSize: '0.75rem' }}>Get in Touch</Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-4">
                {prevBlog && (
                  <Link
                    href={`/media/blogs/${prevBlog.slug}`}
                ...
                {nextBlog && (
                  <Link
                    href={`/media/blogs/${nextBlog.slug}`}
                    className="font-ui text-xs tracking-widest uppercase transition-colors duration-300 flex items-center gap-2"
                    style={{ color: 'rgba(44,62,88,0.45)' }}
                    onMouseEnter={e => { e.currentTarget.style.color = 'var(--gold)' }}
                    onMouseLeave={e => { e.currentTarget.style.color = 'rgba(44,62,88,0.45)' }}
        ...
        <div className="container-luxury">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BLOGS.filter((b) => b.slug !== slug).slice(0, 3).map((relatedBlog, i) => (
              ...
              >
                <Link href={`/media/blogs/${relatedBlog.slug}`} className="block relative overflow-hidden" style={{ aspectRatio: '16/9' }}>
                  <Image src={relatedBlog.image} alt={relatedBlog.title} className="object-cover transition-transform duration-700 group-hover:scale-105" fill sizes="100vw" />
                  <span
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <h3 className="font-times text-base line-clamp-2" style={{ color: 'var(--luxury-dark)', lineHeight: '1.3', height: '2.4em', marginBottom: '0.75rem' }}>
                    <Link href={`/media/blogs/${relatedBlog.slug}`} className="hover:opacity-70 transition-opacity">{relatedBlog.title}</Link>
                  </h3>
                  <Link
                    href={`/media/blogs/${relatedBlog.slug}`}
