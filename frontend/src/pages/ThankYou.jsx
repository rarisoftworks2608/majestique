...
export default function ThankYou() {
  ...
  return (
    <>
      <Seo title="Thank You" description="Thank you for contacting Majestique Landmarks. Our team will be in touch shortly." noindex />
      <section
    ...
    >
      ...
      <div className="container-luxury relative">
        ...
        >
          <Link to="/projects/ongoing" className="btn-gold transition-transform duration-300 hover:scale-105">
            Explore Our Projects
          </Link>
          <Link to="/" className="btn-outline-dark transition-transform duration-300 hover:scale-105">
            Back to Home
          </Link>
        </motion.div>
