  ...
  return (
    <>
      <Seo
        ...
        description="The people who build Majestique Landmarks and the culture behind them: excellence, belonging and purpose-driven work."
      />
      <PageHero
        title="People & Culture"
      ...
      <section className="relative overflow-hidden" style={{ height: 'clamp(300px, 46vh, 520px)' }}>
        <img
          src={BAND}
          alt="Ganpati celebrations at Majestique"
          loading="lazy"
          className="absolute inset-0 w-full h-full object-cover"
      ...
      >
        ...
        <div className="container-luxury flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link to="/careers" className="btn-gold transition-transform duration-300 hover:scale-105">
            View Open Roles
          </Link>
        </div>
      </section>
