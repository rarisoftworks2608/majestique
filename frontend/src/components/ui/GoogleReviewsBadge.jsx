...
function GoogleWordmark() {
  return (
    <div className="flex flex-wrap items-center gap-1.5 w-full">
      ...
      <span className="font-ui leading-none" style={{ fontSize: '0.74rem', color: 'rgba(26,26,26,0.55)', fontWeight: 500 }}>
        Reviews
      </span>
    </div>
  )
...
export default function GoogleReviewsBadge({ className = '' }) {
  return (
    ...
    >
      ...
      <GoogleWordmark />
      <p className="font-body text-xs" style={{ color: 'rgba(26,26,26,0.55)' }}>{SITE_NAME}</p>
